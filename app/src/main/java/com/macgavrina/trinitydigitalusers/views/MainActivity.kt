...
import com.macgavrina.trinitydigitalusers.presenters.MainActivityPresenter
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener, MainActivityContract.View {
    ...
    override fun displayUsersListFragment() {
        val supportFragmentManager = supportFragmentManager
        supportFragmentManager.beginTransaction()
                .replace(R.id.content_main_constraint_layout, UsersListFragment())
